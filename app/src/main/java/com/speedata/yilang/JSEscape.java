...
//	        String stest = "abd";
//		Font f =new Font("方正宋体-人口信息", 0,15);

//	        System.out.println(stest);
//	        System.out.println(escape(stest));
        System.out.println(unescape(stest));
//        System.out.println(decode("4EFB97595982"));
        String write_data = escape("许百茹FF");//.replace("%u", "");
        System.out.println("write_data=" + write_data);
        String read_data = unescape(write_data);
        System.out.println("read_data=" + read_data);
        byte[] temp = write_data.getBytes();
        write_data = new String(temp);
        System.out.println("write_data=" + write_data);
        read_data = unescape(write_data);
        System.out.println("read_data=" + read_data);
//	        JSEscape js =new JSEscape();
//	        String s = js.toFZ(unescape(stest));
